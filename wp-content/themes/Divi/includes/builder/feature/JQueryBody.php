...
class ET_Builder_JQuery_Body {
	...
	public function should_move_jquery() {
		...
		if ( null === self::$_should_move_jquery ) {
			self::$_should_move_jquery = ! ( is_admin() || wp_doing_ajax() || et_is_builder_plugin_active() || is_customize_preview() || is_et_pb_preview() || et_fb_is_enabled() ) && 'on' === et_get_option( $shortname . '_enable_jquery_body', 'on' );
		}
